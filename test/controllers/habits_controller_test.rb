...
class HabitsControllerTest < ActionController::TestCase
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post :create, habit: { habit1: @habit.habit1, habit2: @habit.habit2, habit3: @habit.habit3, user_id: @habit.user_id }
    end
  ...
  test "should update habit" do
    patch :update, id: @habit, habit: { habit1: @habit.habit1, habit2: @habit.habit2, habit3: @habit.habit3, user_id: @habit.user_id }
    assert_redirected_to habit_path(assigns(:habit))
  end
